...
import { Palette, Lightbulb, Award, Star, Camera, Eye, Heart, ExternalLink } from 'lucide-react'
  ...
  return (
    <div className="container" style={{ padding: '2rem 0' }}>
      ...
      <section style={{ marginBottom: '5rem' }}>
        <div className="card" style={{ padding: '3rem', background: 'linear-gradient(135deg, #f8fafc 0%, #e2e8f0 100%)' }}>
      ...
      <section style={{ marginBottom: '5rem' }}>
        ...
        <div className="grid md:grid-cols-3" style={{ gap: '2rem' }}>
          <div className="card" style={{ padding: '2.5rem', textAlign: 'center', border: '2px solid #e5e7eb' }}>
            <div style={{
              width: '5rem',
              height: '5rem',
              backgroundColor: '#3b82f6',
      ...
      <section>
        ...
        <div className="grid lg:grid-cols-2" style={{ gap: '2.5rem' }}>
          {filteredPortfolio.map((project) => (
            <div key={project.id} className="card" style={{ overflow: 'hidden', border: '2px solid #e5e7eb' }}>
              {/* Main Image */}
